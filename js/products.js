...
const products = [
  ...
  // ========== 风水摆件类 ==========
  {
    ...
    images: ['https://cf.cjdropshipping.com/quick/product/7c05fd42-9605-4f3a-b791-f0d547658644.jpg'],
    description: {
  ...
  // ========== 塔罗占卜类 ==========
  {
    ...
    images: ['https://oss-cf.cjdropshipping.com/product/2026/07/06/12/cd360fae-ebfb-4265-a1f2-bd062ed69e4a.jpg'],
    description: {
  ...
  // ========== 香薰类 ==========
  {
    ...
    images: ['https://oss-cf.cjdropshipping.com/product/2026/07/06/12/21657730-346c-448f-b633-60cd179509b0_trans.jpeg'],
    description: {
  ...
  // ========== 佛教/冥想类 ==========
  {
    ...
    images: ['https://oss-cf.cjdropshipping.com/product/2026/07/06/11/4de723c9-d3f3-4e9a-ac45-36108982dc83_trans.jpeg'],
    description: {
